        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Henk is committed to protecting your personal data and respecting
              your privacy rights in accordance with the General Data Protection
              Regulation (GDPR).
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              When we transfer your data outside the EU, we ensure appropriate
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              For any GDPR-related questions or to exercise your rights, contact
              us at{" "}
              <a
