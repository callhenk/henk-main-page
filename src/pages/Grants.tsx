  ...
  return (
    <div className="min-h-screen relative">
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          Voice AI Grant for Charities | £10K Free AI Voice Credits | Henk
        </title>
        <meta
          name="title"
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "£10K worth of free AI voice credits for charities conducting telephone fundraising. Includes 35,000 minutes of conversation and full platform access for 12 months.",
            amount: {
              "@type": "MonetaryAmount",
              currency: "GBP",
              value: "10000",
            ...
            funder: {
              ...
              sameAs: ["https://twitter.com/callhenk"],
            },
            availableIn: [
              {
                "@type": "Country",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <p className="text-xl md:text-2xl lg:text-3xl text-gray-400 max-w-3xl mx-auto font-light leading-relaxed">
                Build realistic AI voice agents to help your charity scale phone
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <Reveal delay={0.2}>
            <div className="space-y-8 text-lg md:text-xl text-gray-700 leading-relaxed">
              <p>
                For most charities, the telephone is one of the most, if not the
                most, important fundraising and stewardship channel.
              </p>
              <p>
                However, it's becoming more and more difficult (and expensive)
                to take advantage of it. Teams are short staffed, making it near
                impossible to engage supporters effectively.
              </p>
              <p>
                Our platform gives your organization the tools and expertise you
                need to test how voice AI can support your call teams, without
                the financial risk. This includes £10K worth of AI voice credits
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-7">
                  ...
                  <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-6">
                    Talk to Lisa, our AI grant manager, to discuss your
            ...
            <Reveal delay={0.2}>
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center lg:grid-flow-dense">
                ...
                <div className="lg:col-span-7 lg:col-start-1 lg:row-start-1">
                  ...
                  <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-6">
                    Our team reviews your eligibility and organizational fit. We
                    evaluate your mission alignment, fundraising goals, and
              ...
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
                ...
                <div className="lg:col-span-7">
                  ...
                  <p className="text-lg md:text-xl text-gray-600 leading-relaxed mb-6">
                    ...
                    Get full access to our AI platform and start reaching more
                    donors immediately.
                  </p>
                  <div className="flex items-center gap-2">
                    <div className="h-1 w-12 bg-blue-600 rounded-full" />
        ...
        <div className="container mx-auto px-6 max-w-7xl relative">
          <Reveal className="text-center mb-24">
            ...
            <p className="text-xl md:text-2xl text-gray-700 font-light max-w-3xl mx-auto">
              Use £10K worth of AI voice credits. That's 35,000 minutes of
              conversation!
            </p>
          </Reveal>
      ...
      <section className="py-32 bg-white relative z-10">
        <div className="container mx-auto px-6 max-w-6xl">
          <Reveal className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-700 font-light max-w-3xl mx-auto">
              We support both advocacy and service non profits in the US, UK,
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16">
            <Reveal delay={0.1}>
              <div className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Currently conducting telephone fundraising campaigns, either
                  via an in-house team or an agency. If you're just planning to
                  get started with telephone fundraising, your organization is
                  also eligible.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.2}>
              <div className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Must be a registered non profit in the country where you are
                  registered in.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="space-y-6">
                ...
                <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
                  Commitment to launch within 3 months of grant approval with
                  dedicated team support for implementation.
                </p>
              </div>
            </Reveal>
          </div>
          ...
          <Reveal>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
                Visit our comprehensive FAQ for details on eligibility,
                application process, and more. Reach out to us at{" "}
                <a
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <motion.button
                  className="bg-blue-600 text-white px-12 py-5 rounded-full text-lg font-semibold hover:bg-blue-700 transition-all duration-300 shadow-xl inline-flex items-center gap-2"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={() =>
                    window.open(
      ...
      <section
        id="apply-section"
        className="py-32 bg-white/10 backdrop-blur-sm relative z-10"
      >
        <div className="container mx-auto px-6">
          <Reveal className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-3xl mx-auto font-light">
              Chat with our AI assistant to begin the grant application process.
              Share your organization's story and fundraising goals.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            <GrantChat
              ...
              backendUrl={
                import.meta.env.VITE_BACKEND_URL || "https://app.callhenk.com"
              }
            />
          </Reveal>
        </div>
