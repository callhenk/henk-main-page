        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              By accessing and using Henk's services, you accept and agree to be bound by the terms 
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Henk provides AI-powered voice agent services for telephone fundraising automation. 
              Our service helps charities conduct natural conversations with donors and supporters.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-2">
              ...
              <li>Respect the privacy and rights of individuals contacted through our service</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Henk shall not be liable for any indirect, incidental, special, consequential, 
