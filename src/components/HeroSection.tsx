        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Transform your charity's fundraising with AI that speaks naturally, 
                understands donors deeply, and works tirelessly to advance your mission.
              </p>
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-glow transform hover:scale-105 transition-all duration-500">
              <img 
                src={heroImage} 
                alt="Henk AI Voice Technology for Fundraising" 
            ...
            <div className="absolute -bottom-6 -right-6 bg-card/95 backdrop-blur-sm p-6 rounded-xl shadow-glow border border-accent/20 animate-fade-in hover-scale">
              ...
              <div className="text-sm font-semibold text-foreground">24/7 Calls</div>
